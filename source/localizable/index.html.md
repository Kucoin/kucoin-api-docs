...
But you need to be aware that the timestamps between **matching engine** and **order** system is nanosecond.
...
If asset is deposited, the system will automatically create an account. But if you can't get an account for the asset through the API, you need to create an account.
...
You can filter your orders through clientOid, but it will be posted to L3 message (it may cause your order strategy to be known for others), it is recommended that you can use UUID as clientOid.
...
<aside class="notice">You can filter your orders through clientOid, but it will be posted to L3 message (it may cause your order strategy to be known for others), it is recommended that you can use UUID as clientOid.</aside>
